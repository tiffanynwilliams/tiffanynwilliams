...
**Analytics & Data**
`Python` `SQL` `Pandas` `NumPy` `Excel` `Statistical Analysis` `EDA` `Data Cleaning & Validation`

**Operations & Workflow**
`Jira` `PagerDuty` `Incident Triage` `Runbooks` `Workflow Documentation`

**UX & Research**
`Figma` `UX Research` `User Interviews` `HCI` `Accessibility Analysis`

**Technical**
`Git` `HTML` `CSS` `JavaScript` `Jupyter Notebook`

---

## 📌 Featured Projects

### [Access Denied: Reproductive Health in Post-Dobbs America](https://github.com/tiffanynwilliams/access-denied-reproductive-health)
Data storytelling project examining how Dobbs v. Jackson reshaped reproductive healthcare access, maternal mortality, and health disparities across the U.S. using CDC, Guttmacher, and Census data.
`Python` `Pandas` `Plotly` `Streamlit` `Public Health Data`

### [HR / Health Data Pipeline](https://github.com/tiffanynwilliams/hr_data_pipeline)
Exploratory analysis pipeline for health-related datasets — cleaning, validation, and trend analysis.
`Python` `Pandas` `Jupyter`

### TULiP/ORCHID Healthcare App *(NJBWPA)*
Co-built a database-driven platform connecting Black patients to providers — 200+ users served. Led technical planning, requirements gathering, and UX research.
`Healthcare Tech` `UX Research` `Database Design` `Accessibility`
